...
reconstruction in the previous notebook with the high-level workflow.
...
Let’s again create the ``job`` object and load the configuration YAML
file. To distinguish between the 1st reconstruction, let’s specify the
``job_dirpath`` in the call, which indicates the path where we store our
...
.. parsed-literal::
    ...
    [1m[36mLMRt: job.load_configs() >>> job.configs["job_dirpath"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high[0m
    [1m[32mLMRt: job.load_configs() >>> /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high created[0m
    {'anom_period': [1951, 1980],
     'job_dirpath': '/Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high',
...
Now let’s prepare our ``job`` with the ``.prepare()`` method, which will
take care of the steps prior to the “Data assimilation” section in the
previous notebook.
...
.. parsed-literal::
    ...
    [1m[36mLMRt: job.calibrate_psm() >>> job.configs["precalc"]["seasonalized_prior_path"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/seasonalized_prior.pkl[0m
    [1m[36mLMRt: job.calibrate_psm() >>> job.configs["precalc"]["seasonalized_obs_path"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/seasonalized_obs.pkl[0m
    [1m[36mLMRt: job.calibrate_psm() >>> job.configs["precalc"]["prior_loc_path"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/prior_loc.pkl[0m
    [1m[36mLMRt: job.calibrate_psm() >>> job.configs["precalc"]["obs_loc_path"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/obs_loc.pkl[0m
    [1m[36mLMRt: job.calibrate_psm() >>> job.configs["precalc"]["calibed_psm_path"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/calibed_psm.pkl[0m
...
.. parsed-literal::
    ...
    Searching nearest location: 100%|██████████| 95/95 [00:05<00:00, 17.35it/s]
...
.. parsed-literal::
    ...
    Searching nearest location:   6%|▋         | 6/95 [00:00<00:01, 58.38it/s]
...
.. parsed-literal::
    ...
    Searching nearest location: 100%|██████████| 95/95 [00:01<00:00, 61.54it/s]
    Calibrating PSM:   9%|▉         | 9/95 [00:00<00:01, 84.72it/s]
...
.. parsed-literal::
    ...
    Calibrating PSM:  62%|██████▏   | 59/95 [00:00<00:00, 90.68it/s]
...
.. parsed-literal::
    ...
    Calibrating PSM: 100%|██████████| 95/95 [00:01<00:00, 90.51it/s]
    Forwarding PSM: 100%|██████████| 95/95 [00:00<00:00, 1442.56it/s]
...
.. parsed-literal::
    ...
    [1m[36mLMRt: job.prepare() >>> Prepration data saved to: /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/job.pkl[0m
    [1m[36mLMRt: job.prepare() >>> job.configs["precalc"]["prep_savepath"] = /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/job.pkl[0m
...
.. parsed-literal::
    ...
    [1m[36mLMRt: job.run() >>> job.configs saved to: /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/job_configs.yml[0m
    [1m[36mLMRt: job.run() >>> seed: 0 | max: 0[0m
    [1m[36mLMRt: job.run() >>> randomized indices for prior and proxies saved to: /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/job_r00_idx.pkl[0m
...
.. parsed-literal::
    ...
    KF updating: 100%|██████████| 2001/2001 [00:44<00:00, 44.48it/s] 


.. parsed-literal::

    [1m[36mLMRt: job.save_recon() >>> Reconstructed fields saved to: /Users/fzhu/Github/LMRt/docs/tutorial/testcases/PAGES2k_CCSM4_GISTEMP/recon_high/job_r00_recon.nc[0m
